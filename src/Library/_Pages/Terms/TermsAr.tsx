			...
			<TermsContainer>
				<article>
					<header>
						...
						<p>
							<em>Last updated January 01, 2025</em>
						</p>
					</header>
					<div>
						<hr />
						...
						<p>
							We are <a href="https://elpmp.com/">ELPMP.com</a> Limited Company, doing business as{" "}
							<a href="https://elpmp.com/">ELPMP.com</a> Limited Company (&quot;Company,&quot;
							&quot;we,&quot; &quot;us,&quot; &quot;our&quot;), a company registered in Delaware,
							United States at 1151 Walker Rd, Ste 474, Dover, DE 19904.
						</p>
						<p>
							We operate the website <a href="https://www.elpmp.com">https://www.elpmp.com</a> (the
							&quot;Site&quot;), as well as any other related products and services that refer or
							link to these legal terms (the &quot;Legal Terms&quot;) (collectively, the
							&quot;Services&quot;).
						</p>
						<p>
							<a href="https://elpmp.com/">ELPMP.com</a> is a cutting-edge online platform dedicated
							to empowering project management professionals with expert-led courses tailored for
							PMI certification. Offering flexible, self-paced learning, interactive exam
							simulations, and practical skill development,{" "}
							<a href="https://elpmp.com/">ELPMP.com</a> ensures a seamless path to career
							advancement. With a focus on accessibility, affordability, and excellence, it serves
							individuals and organizations across the GCC region and beyond, fostering success in
							project management.
						</p>
						<p>
							You can contact us by phone at +1(302)887-2020, email at{" "}
							<a href="mailto:hello@elpmp.com">hello@elpmp.com</a>, or by mail to 1151 Walker Rd,
							Ste 474, Dover, DE 19904, United States.
						</p>
						<p>
							These Legal Terms constitute a legally binding agreement made between you, whether
							personally or on behalf of an entity (&quot;you&quot;), and{" "}
							<a href="http://elpmp.com/">ELPMP.com</a> Limited Company, concerning your access to
						...
						<p>
							...
							<a href="mailto:hello@elpmp.com">hello@elpmp.com</a>, as stated in the email message.
						...
						<ol>
							...
							<li>
								<strong>DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</strong>
							</li>
							<li>
						...
						<p>
							...
							<a href="https://www.notion.so/mustafamaher/link">
						...
						<p>
							...
							<a href="mailto:hello@elpmp.com">hello@elpmp.com</a>. If we ever grant you the
						...
						<ul>
							<li>
								Use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store,
								publicly perform, publicly display, reformat, translate, excerpt (in whole or in
								part), and exploit your Contributions (including, without limitation, your image,
								...
								sublicense the licenses granted in this section. Our use and distribution may occur
						...
						<p>
							Although we have no obligation to monitor any Contributions, we shall have the right
							to remove or edit any Contributions at any time without notice if in our reasonable
							opinion we consider such Contributions harmful or in breach of these Legal Terms. If
						...
						<p>
							...
							change prices at any time. All payments shall be in multiple currencies.
						</p>
						<p>
						...
						<p>
							Subscriptions will not be renewed automatically. We will contact you by email prior to
							expiry to ask if you wish to renew your subscription and communicate the cost of
						...
						<p>
							...
							please email us at <a href="mailto:hello@elpmp.com">hello@elpmp.com</a>.
						</p>
						<h3>Fee Changes</h3>
						<p>
						...
						<ul>
							...
							<li>
								Upload or transmit (or attempt to upload or transmit) viruses, Trojan horses, or
						...
						<p>
							...
							other works, such Contributions, and grant and authorize sublicenses of the foregoing.
						...
						<ol>
							...
							<li>
								You may not organize a campaign encouraging others to post reviews, whether positive
								or negative.
							</li>
						</ol>
						<p>
						...
						<p>
							...
							the connection between your account on the Services and your Third-Party Accounts at
							any time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS
						...
						<ol>
							...
							<li>
								In our sole discretion and without limitation, notice, or liability, remove from the
						...
						<p>
							...
							<a href="https://elpmp.com/privacy">https://elpmp.com/privacy</a>. By using the
							...
							Egypt, Saudi Arabia, and United Arab Emirates. If you access the Services from any
							...
							Egypt, Saudi Arabia, and United Arab Emirates, then through your continued use of the
							Services, you are transferring your data to the United States, Egypt, Saudi Arabia,
							and United Arab Emirates, and you expressly consent to have your data transferred to
							and processed in the United States, Egypt, Saudi Arabia, and United Arab Emirates.
						</p>
						<hr />
						<h3>16. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</h3>
						<p>
							<strong>Notifications</strong> We respect the intellectual property rights of others.
							If you believe that any material available on or through the Services infringes upon
							any copyright you own or control, please immediately notify our Designated Copyright
						...
						<p>
							All Notifications should meet the requirements of DMCA 17 U.S.C. &sect; 512(c)(3) and
							...
							or, if multiple copyrighted works on the Services are covered by the Notification, a
							...
							sufficient to permit us to locate the material; (4) information reasonably sufficient
							...
							accurate, and under penalty of perjury, that the complaining party is authorized to
							act on behalf of the owner of an exclusive right that is allegedly infringed upon.
						</p>
						<p>
							<strong>Counter Notification</strong> If you believe your own copyrighted material has
							been removed from the Services as a result of a mistake or misidentification, you may
							submit a written counter notification to [us/our Designated Copyright Agent] using the
							...
							substantially the following: (1) identification of the material that has been removed
							or disabled and the location at which the material appeared before it was removed or
							disabled; (2) a statement that you consent to the jurisdiction of the Federal District
							Court in which your address is located, or if your address is outside the United
							States, for any judicial district in which we are located; (3) a statement that you
							will accept service of process from the party that filed the Notification or the
							party&apos;s agent; (4) your name, address, and telephone number; (5) a statement
							under penalty of perjury that you have a good faith belief that the material in
							question was removed or disabled as a result of a mistake or misidentification of the
						...
						<p>
							...
							filed a court action to restrain you from engaging in infringing activity related to
							the material in question. Please note that if you materially misrepresent that the
							disabled or removed content was removed by mistake or misidentification, you may be
							liable for damages, including costs and attorney&apos;s fees. Filing a false Counter
							Notification constitutes perjury.
						</p>
						<p>
							Designated Copyright Agent Mustafa Maher Attn: Copyright Agent 1151 Walker Rd, Ste
							4741 Dover, DE 19904 United States{" "}
							<a href="mailto:hello@elpmp.com">hello@elpmp.com</a>
						</p>
						<hr />
						...
						<p>
							...
							accordance with the laws of the State of Wyoming applicable to agreements made and to
							be entirely performed within the State of Wyoming, without regard to its conflict of
							law principles.
						</p>
						<hr />
						...
						<p>
							...
							arbitration will take place in Wyoming. Except as otherwise provided herein, the
						...
						<p>
							...
							shall be commenced or prosecuted in the state and federal courts located in Wyoming,
							Wyoming, and the Parties hereby consent to, and waive all defenses of lack of personal
							...
							Act (UCITA) are excluded from these Legal Terms. In no event shall any Dispute brought
							by either Party related in any way to the Services be commenced more than one (1)
							years after the cause of action arose. If this provision is found to be illegal or
						...
						<p>
							<strong>Exceptions to Informal Negotiations and Arbitration</strong> The Parties agree
							...
							this provision is found to be illegal or unenforceable, then neither Party will elect
						...
						<p>
							<strong>Message and Data Rates</strong> Please be aware that message and data rates
							may apply to any SMS messages sent or received. The rates are determined by your
							carrier and the specifics of your mobile plan. Support
						</p>
						<p>
							If you have any questions or need assistance regarding our SMS communications, please
							email us at <a href="mailto:hello@elpmp.com">hello@elpmp.com</a> or call at
							+1(302)887-2020.
						</p>
						<hr />
						<h3>28. CALIFORNIA USERS AND RESIDENTS</h3>
						<p>
						...
						<p>
							<a href="http://elpmp.com/">ELPMP.com</a> Limited Company 1151 Walker Rd, Ste 474
							Dover, DE 19904 United States Phone: +1(302)887-2020{" "}
							<a href="mailto:hello@elpmp.com">hello@elpmp.com</a>
						</p>
						<h2></h2>
					</div>
